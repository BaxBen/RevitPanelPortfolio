    ...
    public class Main : IExternalApplication
    {
        ...
        private void OVPanel(RibbonPanel panel)
        {
            PushButton button1 = CreateButton(
                ...
                "Пользователь выделяет один экземпляр семейства \"Шаровый кран с муфтой\". " +
                "Плагин строит граф соединений и находит в системе два крана того же типа:\r\n\r" +
                "\nБлижайший — минимальное количество соединений от исходного\r\nСамый дальний —" +
                " максимальное количество соединений (длина пути)"
                );
            
            PushButton button2 = CreateButton(
                panel,
                "Инструмент проверки пересечений",
                "Инструмент проверки \nпересечений",
                typeof(ClashDetectionTool),
